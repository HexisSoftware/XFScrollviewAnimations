...
[assembly: ExportRenderer(typeof(CustomScrollView), typeof(CustomScrollViewiOSRenderer))]
namespace XFScrollviewAnimations.Plugin
{
	...
	public interface IAnimatedScrollViewController
	{
		...
		void AnimatedScrollViewControllerDidScrollToEnd(CustomScrollViewiOSRenderer animatedScrollViewController);
		void AnimatedScrollViewControllerDidEndDraggingAtEnd(CustomScrollViewiOSRenderer animatedScrollViewController);
	}

	public class CustomScrollViewiOSRenderer : ScrollViewRenderer
	{
